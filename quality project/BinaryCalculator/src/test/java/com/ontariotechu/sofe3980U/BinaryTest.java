...
public class BinaryTest {
    ...
    @Test
    public void andWithSameLength() {
        Binary binary1 = new Binary("101010");
        Binary binary2 = new Binary("110100");
        Binary result = Binary.and(binary1, binary2);
        assertTrue(result.getValue().equals("100000"));
    }
    ...
    @Test
    public void multiplyWithSameLength() {
        Binary binary1 = new Binary("1010");
    ...
    @Test
    public void multiplyWithDifferentLength() {
